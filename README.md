...
functional right now. Phase 1, 2 and 7 are. Phase 1 and 2 are the data generation phases, and phase 7 is testing. The final model can be loaded into the ipynb and tested in Phase 7. We can also generate new data in Phase 1/2 for testing with FirstIterate in phase 7.
